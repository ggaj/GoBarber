...
var FakeUserTokensRepository = /** @class */ (function () {
    ...
    FakeUserTokensRepository.prototype.generate = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                Object.assign(userToken, { id: uuidv4_1.uuid(), token: uuidv4_1.uuid(), user_id: user_id, created_at: new Date(), updated_at: new Date() });
    ...
    FakeUserTokensRepository.prototype.findByToken = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var userToken;
            return __generator(this, function (_a) {
                userToken = this.userTokens.find(function (user) { return user.token === token; });
                return [2 /*return*/, userToken];
            });
        });
    };
