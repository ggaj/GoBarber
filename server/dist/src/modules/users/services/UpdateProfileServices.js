...
var UpdateProfileUserServices = /** @class */ (function () {
    function UpdateProfileUserServices(userRepository, hashProvider) {
        this.userRepository = userRepository;
        this.hashProvider = hashProvider;
    }
    UpdateProfileUserServices.prototype.execute = function (_a) {
                ...
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        if (password && !old_password) {
                            throw new AppError_1.default('You need to inform old password to set new password');
                        }
    ...
    UpdateProfileUserServices = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject('UsersRepository')),
        __param(1, tsyringe_1.inject('HashProvider')),
        __metadata("design:paramtypes", [Object, Object])
    ], UpdateProfileUserServices);
    return UpdateProfileUserServices;
}());
exports.default = UpdateProfileUserServices;
