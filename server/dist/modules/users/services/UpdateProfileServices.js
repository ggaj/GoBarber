...
let UpdateProfileUserServices = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec4 = Reflect.metadata("design:type", Function), _dec5 = Reflect.metadata("design:paramtypes", [typeof _IUsersRepository.default === "undefined" ? Object : _IUsersRepository.default, typeof _IHashProvider.default === "undefined" ? Object : _IHashProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = class UpdateProfileUserServices {
  ...
  async execute({
    ...
    if (password && !old_password) {
      throw new _AppError.default('You need to inform old password to set new password');
    }
